...
cp /root/ctbot-viewer/deploy-scripts/ctbot-viewer.desktop /root/ctbot-viewer/deploy/
cp /root/ctbot-viewer/deploy-scripts/ctbot.png /root/ctbot-viewer/deploy/
rm -rf /root/ctbot-viewer/build

/root/linuxdeployqt/bin/linuxdeployqt /root/ctbot-viewer/deploy/ctbot-viewer.desktop -qmldir=/root/ctbot-viewer -extra-plugins=iconengines,platformthemes/libqgtk3.so -always-overwrite -verbose=1 -no-translations -bundle-non-qt-libs
